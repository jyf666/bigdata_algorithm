...
if __name__=='__main__':
    main()
    X = datasets.make_low_rank_matrix(n_samples=100,n_features=100,effective_rank=10,random_state=None)
    Y = datasets.make_low_rank_matrix(n_samples=100, n_features=1, effective_rank=10,random_state=None)
    print(X)
    plt.plot(X,Y)
    plt.show()
